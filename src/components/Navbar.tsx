...
import { changeSearchQuery, clearSearchQuery } from "../store";
...
export default function Navbar() {
  ...
  const searchQuery = useAppSelector((state) => state.youtubeReducer.query);
  ...
  return (
    <div className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
      ...
      <img
        src="https://yt3.ggpht.com/ytc/AMLnZu-PVY6qgBSizsVjHROKLmSEXBAArln-U9ckcqeM9fUEzxRyPdLiRlyQwVhVu8gy=s88-c-k-c0x00ffffff-no-rj-mo"
        alt="yt profile"
