...
export default function Sidebar() {
  const mainLinks: IIconsType["mainLinks"] = [
    {
  ...
  const secondaryLinks: IIconsType["mainLinks"] = [
    {
  ...
  const subscriptionLinks: IIconsType["mainLinks"] = [
    {
  ...
  const helpLinks: IIconsType["mainLinks"] = [
    {
  ...
  const textLinks: IIconsType["textLinks"] = [
    [
      "About",
      "Press",
      "Copyright",
  ...
  return (
    <div className="w-2/12 bg-[#212121] pr-5 overflow-scroll pb-8 sidebar">
